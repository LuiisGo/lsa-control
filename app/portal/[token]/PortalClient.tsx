      ...
      <div className="min-h-screen bg-[#1e3a5f] flex items-center justify-center p-4">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <img
              src="/LSA-Logo.png"
              alt="Agrícola San Antonio"
              width={88}
              height={88}
              className="mx-auto mb-4 rounded-full bg-white object-contain p-1 shadow-lg"
            />
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="bg-[#1e3a5f] text-white px-4 py-4 sticky top-0 z-10">
        <div className="max-w-2xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/LSA-Logo.png" alt="" width={40} height={40} className="rounded-full bg-white object-contain p-0.5 shrink-0" />
            <div>
      ...
      <main className="max-w-2xl mx-auto px-4 py-6 space-y-4">
        ...
        {/* ── Hoy ────────────────────────────────────────────── */}
        <Accordion title={`Tus entregas de hoy — ${d.hoy.fecha}`} defaultOpen>
        ...
        {/* ── Período actual ─────────────────────────────────── */}
        <Accordion title={`Esta ${d.frecuenciaPago === 'semanal' ? 'semana' : 'quincena'} — ${d.periodoActual.tipo}`} defaultOpen>
        ...
        {/* ── Período anterior ───────────────────────────────── */}
        <Accordion title={`${d.frecuenciaPago === 'semanal' ? 'Semana' : 'Quincena'} anterior — ${d.periodoAnterior.tipo}`}>
          <div className="flex items-center justify-between mb-4 text-sm text-slate-500">
